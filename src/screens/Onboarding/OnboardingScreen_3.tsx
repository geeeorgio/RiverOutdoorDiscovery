...
const OnboardingScreen_3 = () => {
  ...
  const handleNext = () => navigation.navigate('OnboardingScreen_4');

  return (
    <ImageBackground
      source={ONBD_IMAGES.onbd_3}
        ...
        <View style={styles.headerContainer}>
          ...
          <View style={styles.textContainer}>
            <CustomText variant="regular" style={styles.description}>
              {ONBOARDING_INFO.onboarding_4.description}
            </CustomText>
          </View>
        </View>
        ...
        <View style={styles.footerContainer}>
          <View style={styles.indexContainer}>
            {Array.from({ length: 5 }).map((_, index) => (
              <View
                key={index}
                style={
                  index === ONBOARDING_INFO.onboarding_4.index
          ...
          >
            <CustomText variant="btnText" style={styles.nextButtonText}>
              {ONBOARDING_INFO.onboarding_4.buttonText}
            </CustomText>
          </CustomButton>
        </View>
      </SafeAreaView>
